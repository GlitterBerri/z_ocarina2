 ...
 * by "rgb2c" from the file "font_fg_ef_int"_
 *
 *   Size: 16 x 16
 ...
 *   gsDPLoadTextureBlock_4b (font_fg_ef_txt, G_IM_FMT_I, 16, 16, 0,
...
// Gfx font_fg_ef_txt_C_dummy_aligner1[] = { //EndDisplayList() };

unsigned char font_fg_ef_txt[] = {
